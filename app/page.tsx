  ...
  return (
    <div>
      ...
      {completedAuctions.length > 0 && (
        <>
          <div className="glow-line" />
          <section className="py-20" style={{ background: 'rgba(13,13,26,0.4)' }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                <p className="text-xs font-bold uppercase tracking-widest text-gold mb-3">Past Shows</p>
                <h2 className="section-title">Recent Results</h2>
                <p className="text-gray-500 mt-1 text-sm">See who won what in our completed auctions.</p>
              </div>
